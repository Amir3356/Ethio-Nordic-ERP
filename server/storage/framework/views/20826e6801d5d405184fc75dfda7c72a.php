...
<body>
    ...
    <div class="content">
        ...
        <div class="qr-box">
            <img src="<?php echo e($qrCodeUrl); ?>" alt="2FA QR Code" style="max-width: 250px;">
        </div>
        ...
        <div class="recovery-codes">
            ...
            <div style="text-align: center;">
                <?php $__currentLoopData = $recoveryCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="recovery-code"><?php echo e($code); ?></span>
...
<?php /**PATH C:\Users\hp\Desktop\Ethio-Nordic-ERP\server\resources\views\emails\two-factor-setup.blade.php ENDPATH**/ ?>